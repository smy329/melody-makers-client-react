      ...
      <div className="relative container mx-auto">
        ...
        >
          <SwiperSlide>
            ...
            <div className="w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
              <div className="text-white space-y-8 text-center">
                <h1 className="text-8xl">Music for Everyone</h1>
                <p className="text-4xl font-light ">Awaken Possibility</p>
                <div className="w-3/12 mx-auto">
                  <button className="bg-blue-500 w-full font-medium text-white text-xl rounded-full py-5 px-8">
                    START LEARNING
                  </button>
                </div>
              </div>
          ...
          <SwiperSlide>
            ...
            <div className="w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
              <div className="text-white space-y-8 text-center">
                <h1 className="text-8xl">Music is Your World</h1>
                <p className="text-4xl font-light ">Don't Miss a Chance</p>
                <div className="w-3/12 mx-auto">
                  <button className="bg-blue-500 w-full font-medium text-white text-xl rounded-full py-5 px-8">
                    START LEARNING
                  </button>
          ...
          <SwiperSlide>
            ...
            <div className="w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
              <div className="text-white space-y-8 text-center">
                <h1 className="text-8xl">Start With a Note</h1>
                <p className="text-4xl font-light ">Awaken Possibility</p>
                <div className="w-3/12 mx-auto">
                  <button className="bg-blue-500 w-full font-medium text-white text-xl rounded-full py-5 px-8">
                    START LEARNING
